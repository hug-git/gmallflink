package com.hug.app.dwm;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.hug.app.func.DimAsyncFunction;
import com.hug.bean.OrderDetail;
import com.hug.bean.OrderInfo;
import com.hug.bean.OrderWide;
import com.hug.utils.DimUtil;
import com.hug.utils.MyKafkaUtil;
...
//数据  Web/App -> Nginx -> SpringBoot -> Mysql(Binlog) -> FlinkApp -> Kafka(ods) -> Flink -> Kafka(dwd)/HBase(DIM) -> Flink -> Kafka(dwm)

//进程     Mock -> Mysql(Binlog) -> FlinkCDC -> Kafka(ods_base_db) -> BaseDBApp -> Kafka(dwd_*) -> OrderWideApp(Redis) -> Kafka(dwm_order_wide)
